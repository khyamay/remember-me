...
.config(function($compileProvider) {
    // whitelisting of safe urls during img[src] sanitization provided by angularjs
...
//constant for urls and redirect paths
.constant('FIREBASE_URL', 'https://remember-me.firebaseio.com/notes').constant('MFB_URL', 'https://remember-me.firebaseio.com/messages').constant('IFB_URL', 'https://remember-me.firebaseio.com/images').constant('loginRedirectPath', '/login/signin');
