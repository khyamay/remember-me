angular.module('mainApp.controllers', []).controller('loginCtrl', function($scope, $rootScope, $firebaseSimpleLogin, $window, $state, Auth) {
    ...
    //using firebase login event to see if user are logged it, if they are they will be got notes page 
